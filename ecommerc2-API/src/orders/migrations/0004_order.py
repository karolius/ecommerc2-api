# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2017-01-23 14:55
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('carts', '0006_cart_tax_percentage'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shipping_total_price', models.DecimalField(decimal_places=2, default=5.99, max_digits=30)),
                ('order_total', models.DecimalField(decimal_places=2, default=0.0, max_digits=30)),
